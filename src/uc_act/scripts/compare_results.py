...
Usage:
    python -m uc_act.scripts.compare_results --conv 25
    python -m uc_act.scripts.compare_results --conv 50
    python -m uc_act.scripts.compare_results --conv 100
    python -m uc_act.scripts.compare_results --conv 25 --compare_with 10 50
"""
