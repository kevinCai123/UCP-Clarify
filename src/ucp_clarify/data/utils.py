...
from ucp_clarify.data.base_dataset import ACTDataset
from ucp_clarify.models.preference_model import RejectedSampleModel
from ucp_clarify.utils.storage_utils import read_jsonl
...
def get_datasets_from_config(
  ...
  if not preference_model and not config.training_config.is_preference:
