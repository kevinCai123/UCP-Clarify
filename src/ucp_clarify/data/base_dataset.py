...
from ucp_clarify.data.preference_generator import BaseGenerator
      ...
      for i, message in enumerate(sample["messages"]):
        if message["role"] == self.system_role:
          ...
          if self.assess_clarification(message):
            ...
            rejected_policy = "ANSWER" #a'_i = complement(CLARIFY) = ANSWER
            ...
            rejected_policy = "CLARIFY" #a'_i = complement(ANSWER) = CLARIFY
            chosen_response = output_text
